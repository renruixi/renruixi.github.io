    ...
    geoSuccess: function (pos) {
        $.ajax({
            ...
            beforeSend : function (xhr) {
                xhr.setRequestHeader("Access-Control-Allow-Origin : http://renruixi.github.io/renruixiBlog/")
            },
        ...
        g.searchQuery = 'http://apis.baidu.com/heweather/weather/free?city=ÉîÛÚ';
        var settings = {
            headers: {
